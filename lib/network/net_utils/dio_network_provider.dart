...
import 'package:breach_assessment/network/exceptions/error_code.dart';
import 'package:breach_assessment/network/exceptions/ground_exception.dart';
import 'package:breach_assessment/network/exceptions/response_exceptions.dart';
import 'package:breach_assessment/network/net_utils/interceptors.dart';
...
class AppNetworkProvider {
  ...
  Future<Either<BaseError, Response?>> download({
    required String path,
